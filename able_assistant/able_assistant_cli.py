...
async def able_table(hypothesis: str, research_document: str) -> str:
    """
    ...
    messages = [
        ...
        UserMessage(content=f"Here is the user's hunting hypothesis: {hypothesis}\n", source="user")
    ]
...
if __name__ == "__main__":
    ...
    parser.add_argument('-y', '--hypothesis', help='The hunting hypothesis', required=True, default="")
    ...
    able_table = asyncio.run(able_table(args.hypothesis, research_data))
    print(able_table)
