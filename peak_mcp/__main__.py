...
def embeddable_object(
    ...
    resource = types.TextResourceContents(uri=uri, text=data, mimeType=content_type)
    return types.EmbeddedResource(
        type="resource", resource=resource, annotations={"audience": ["user"]}
    )
