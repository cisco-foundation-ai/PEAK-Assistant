...
async def test_github_oauth_discovery():
    ...
    try:
        ...
        if discovered_config:
            ...
            print(f"   Supported scopes: {discovered_config.get('scopes_supported', 'Not specified')}")
...
async def test_manual_config_precedence():
    ...
    try:
        ...
        if "manual-override.example.com" in token_url and "manual-override.example.com" in auth_url:
    ...
    try:
        ...
        if discovered_config:
            ...
            try:
                ...
                print("✅ Authorization URL correctly not needed for client credentials")
